...
//   const QuizBadge({Key key, this.quizId, this.subject}) : super(key: key);
...
//     if (report != null) {
//       List completed = report.topics[subject.id];
...
//         child: Text(
//           '${report.subjects[topic.id]?.length ?? 0} / ${topic?.quizzes?.length ?? 0}',
...
//       int completedQuizzes = report.subjects[topic.id].length;
